...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        var design_choice = readData("design_choice");
        ...
        res.render('showResults', {results: [design_choice, first_name, last_name, email, quality, aspect]});
        console.log([design_choice, first_name, last_name, email, quality, aspect]);
    });
    ...
    app.post('/niceSurvey', urlencodedParser, function(req, res){
        ...
        for (var key in json){
            ...
            if ((key === "design_choice")&& (json[key].length > 1)){
                console.log("testing");
